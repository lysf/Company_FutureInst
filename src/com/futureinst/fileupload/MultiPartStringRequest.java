...
public class MultiPartStringRequest extends Request<String> implements MultiPartRequest{
	...
	private List<String> fileNameUploads = new ArrayList<String>();
    ...
    public void addFileNameUpload(String fileName){
    	fileNameUploads.add(fileName);
    }
    /**
     * 要上传的文件
     */

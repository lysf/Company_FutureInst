...
public class SharePreferenceUtil {
    ...
    private String DAILY_TASK = "DAILY_TASK";
    private String DAILY_TASK_CLICK = "DAILY_TASK_CLICK";

    public void setDailyTaskClick(){
        editor.putBoolean(DAILY_TASK_CLICK,true);
        editor.commit();
    }
    public boolean getDailyTaskClick(){
        return mSharedPreferences.getBoolean(DAILY_TASK_CLICK,false);
    }
    public void setDailyTaskTip(){
        editor.putBoolean(DAILY_TASK,true);
        editor.commit();
    }
    public boolean getDailyTaskTip(){
        return mSharedPreferences.getBoolean(DAILY_TASK,false);
    }


    public void setServer(boolean isOnline) {
        editor.putBoolean(SERVER, isOnline);
        editor.commit();
    }
    public boolean getServerOnline(){//是否是线上服务器
        return mSharedPreferences.getBoolean(SERVER,false);
    }

 ...
 */
public class UserCheckConsumeFragment extends BaseFragment implements PullListView.OnRefreshListener{
    ...
    protected void localOnCreate(Bundle savedInstanceState) {
        ...
        channel = ((UserCheckActivity)getActivity()).getConsumeScreen();
        initView();
...
//                    startActivity(intentPoint);
    ...
    private void getData(final int page,String last_id,String channel) {
        httpResponseUtils.postJson(httpPostParams.getPostParams(
                        ...
                        httpPostParams.query_user_check(preferenceUtil.getID()+"",preferenceUtil.getUUid(),page,last_id,"consume",channel)), UserCheckInfo.class,

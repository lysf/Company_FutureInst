...
public class SecondTitleActivity extends BaseActivity {
	...
	private void initView() {
		...
		listView = (ListView) findViewById(R.id.lv_second_title);
		SecondTitleListAdapter adapter = new SecondTitleListAdapter(this,
				primaryTitle, target);

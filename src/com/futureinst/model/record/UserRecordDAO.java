...
public class UserRecordDAO implements Serializable {
	...
	public Long getForeIndex() {
		return foreIndex;
	}
	public void setForeIndex(Long foreIndex) {
	...
	public String toString() {
		return "UserRecordDAO [userId=" + userId + ", allGain=" + allGain + ", avgGain=" + avgGain + ", allEvent="
				+ allEvent + ", gainEvent=" + gainEvent + ", foreIndex=" + foreIndex + ", rank=" + rank + ", lastRank="
				+ lastRank + ", asset=" + asset + ", assure=" + assure + ", status=" + status + ", user=" + user + "]";
	}
}

		...
		try {
			...
			case LOCAL_VIDEO:
				...
				if (path == "") {
					...
					Toast.makeText(MediaPlayerVideo.this, "Please edit MediaPlayerVideo Activity, " + "and set the path variable to your media file path." + " Your media file must be stored on sdcard.", Toast.LENGTH_LONG).show();
					return;
				}
				break;
			case STREAM_VIDEO:
...
//				path = "http://182.92.183.219/videos/future_events/test.mp4";
				...
				if (path == "") {
					// Tell the user to provide a media file URL.
					Toast.makeText(MediaPlayerVideo.this, "Please edit MediaPlayerVideo Activity," + " and set the path variable to your media file URL.", Toast.LENGTH_LONG).show();
					return;
				}
	...
	public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
		Log.v(TAG, "onVideoSizeChanged called ,width="+width+",height="+height);

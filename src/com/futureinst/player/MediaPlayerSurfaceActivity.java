...
@SuppressLint("NewApi")
public class MediaPlayerSurfaceActivity extends Activity implements OnBufferingUpdateListener,
  ...
  private void playVideo(SurfaceTexture surfaceTexture) {
    ...
    try {
      ...
      if (path == "") {
        ...
        Toast.makeText(
            MediaPlayerSurfaceActivity.this,
            "Please edit MediaPlayerSetSurface Activity, "

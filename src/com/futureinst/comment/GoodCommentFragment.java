...
public class GoodCommentFragment extends BaseFragment implements OnRefreshListener{
	...
	private void initView() {
		...
		adapter = new CommentDetailAdapter(getContext(), true);
	...
	private void getComment(String event_id){
		httpResponseUtils.postJson(httpPostParams.getPostParams(PostMethod.query_comment.name(), PostType.comment.name(), 
				httpPostParams.query_comment(event_id, 1)),

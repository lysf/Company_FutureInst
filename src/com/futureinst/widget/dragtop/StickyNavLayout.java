package com.futureinst.widget.dragtop;
...
public class StickyNavLayout extends LinearLayout {
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			} else if (mInnerScrollView instanceof PullListView) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (Math.abs(dy) > mTouchSlop) {
				...
				if (mInnerScrollView instanceof ScrollView) {
					...
					mNav.getLocationOnScreen(location);

					if ((!isTopHidden && dy < 0 ) || (!isTopHidden && dy > 0 &&  location[1] < mTopViewHeight + Content.statusHeight)||
							(c != null //
									&& c.getTop() == 0//
									&& isTopHidden && dy > 0)) {
						lv.hideHeader();

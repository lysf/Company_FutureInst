...
public class WheelView extends ScrollView {
    ...
    private int colorID = R.color.text_color_white;
...
//                        onSeletedCallBack();
                        ...
                        if (remainder > itemHeight / 2) {
                            WheelView.this.post(new Runnable() {
                                @Override
                                public void run() {
                                	int offset = initialY - remainder + itemHeight;
                                	if(offset<0){
                                		offset = 0;
                                	}
                                    WheelView.this.smoothScrollTo(0, offset);
...
//                                    onSeletedCallBack();
    ...
    private TextView createView(final int position,String item) {
        ...
        int padding = Utils.dip2px(context, 6);
        ...
        tv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				int location = selectedIndex / itemHeight + offset;
				Log.i(TAG, "---------------selectedIndex----->>"+location);
				if(onItemSelectListener!=null && location == position){
					onItemSelectListener.onItemSelect(position -1);
				}
			}
		});
        return tv;
...
//            position = divided + offset + 1;
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            ...
            paint.setStrokeWidth(Utils.dip2px(context, 1));
        }
...
//    }
    ...
    public void setTextColorID(int colorID){

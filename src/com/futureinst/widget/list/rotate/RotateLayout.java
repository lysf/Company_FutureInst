package com.futureinst.widget.list.rotate;
...
public class RotateLayout extends LinearLayout {
	...
	public void roate(float roate) {
        ...
        if(bmpW < 1 || bmpH < 1) bmpW = bmpH = 1;
		Matrix mt = new Matrix();
	
//		curHeight -= roate;
//		if(curHeight < 0.01) curHeight = 0.01f;
//		float scale = curHeight/bmpH;
//		if(scale > 1) scale = 1f;
//		mt.postScale(scale, scale);
		
		mt.postRotate(curDegrees = (curDegrees - roate), bmpW / 2, bmpH / 2);
